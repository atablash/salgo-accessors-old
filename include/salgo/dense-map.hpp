...
public:
	...
	using Mapped_Type = std::conditional_t<std::is_same_v<Void_Or_Value,void>, Value_Or_Key, Void_Or_Value>;
...
public:
	...
	protected:
		...
		mutable Key _idx; // TODO: remove for VECTOR, because key == idx
	};
...
private:
	...
	template<class TT, class VV, Dense_Map_Flags F, Dense_Map_Type TY, template<Const_Flag,class,class> class TMPL>
	using _Dense_Map = Dense_Map<TT,VV,F,TY,TMPL>;

public:
	using Dense_Map = _Dense_Map<Key, Mapped_Type, FLAGS, TYPE, ACCESSOR_TEMPLATE>;

	template<Dense_Map_Type NEW_TYPE>
	using Type = Dense_Map_Builder<Key, Mapped_Type, FLAGS, NEW_TYPE, ACCESSOR_TEMPLATE>;
	
	template<template<Const_Flag,class,class> class NEW_TMPL>
	using Accessor_Template = Dense_Map_Builder<Key, Mapped_Type, FLAGS, TYPE, NEW_TMPL>;


	template<Dense_Map_Flags NEW_FLAGS>
	using Flags           = Dense_Map_Builder<Key, Mapped_Type, NEW_FLAGS, TYPE, ACCESSOR_TEMPLATE>;

	template<Dense_Map_Flags NEW_FLAGS>
	using Add_Flags       = Dense_Map_Builder<Key, Mapped_Type, FLAGS |  NEW_FLAGS, TYPE, ACCESSOR_TEMPLATE>;

	template<Dense_Map_Flags NEW_FLAGS>
	using Rem_Flags    = Dense_Map_Builder<Key, Mapped_Type, FLAGS & ~NEW_FLAGS, TYPE, ACCESSOR_TEMPLATE>;
};
