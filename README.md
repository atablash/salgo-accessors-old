[![Build Status](https://travis-ci.org/atablash/salgo-accessors-old.svg?branch=master)](https://travis-ci.org/atablash/salgo-accessors-old)
Salgo
=====
...
>
> The reason we use a proxy object for `e.val` anyway is to make Salgo *const*-correct, and allow proper passing of *const*-ness from the accessor object to the underlying pointed object.
